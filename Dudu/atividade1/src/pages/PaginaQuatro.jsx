...
function PaginaQuatro() {
    ...
    return (
        <main className="flex-content-col vh-80">
            ...
            <h1>Informe um número para multiplicar</h1>

            <input ref={inputRef} className="generic-input" type="number" value={valorParaSomar} onChange={(e) => setValor(e.target.value)} />

            <Link className="next-btn" to="/resultado" onClick={() => calcular(valorParaSomar, "MULTIPLICAR")}>Próximo</Link>
        </main>
    )
}
